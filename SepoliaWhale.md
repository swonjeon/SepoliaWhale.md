...
Call it `Sepolia Test Network`, set the New RPC URL to your Sepolia Geth as `http://IP-OF-GETH-BOX:8545`, Chain ID `11155111`, currency symbol `ETH` (or if you're Bavarian, `SEPPETH`) and Explorer to `https://sepolia.otterscan.io`.
